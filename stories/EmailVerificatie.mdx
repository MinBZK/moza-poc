...
Wanneer een gebruiker een e-mailadres toevoegt of wijzigt, moet dit geverifieerd worden voordat het actief wordt. Dit patroon beschrijft wat er gebeurt als alles goed gaat (de _happy flow_) en wat er gebeurt als het misgaat (de _unhappy flows_).
...
## Als alles goed gaat (happy flow)

De gebruiker wijzigt het e-mailadres en bevestigt dit succesvol.

### 1. Invoer

De gebruiker voert een nieuw e-mailadres in met de actie **Contactgegevens wijzigen** op de pagina **Contactvoorkeuren** en kiest **Opslaan**.
...
- Het invoerveld gebruikt `type="email"`, dit zorgt onder meer voor het juiste toetsenbord op mobiele apparaten
...
<table>
	...
	<tbody>
		<tr>
			...
			<td>Actief</td>
			<td>Opnieuw versturen, Annuleer</td>
		</tr>
		<tr>
...
- Feedbackmeldingen worden aangekondigd via een `aria-live="polite"` regio, zodat schermlezers de statuswijziging voorlezen
